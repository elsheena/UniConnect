  ...
  render: function(user, activePage) {
    ...
    if (isGuest) {
      navItems = [
        ...
        { id: 'tests', label: 'System Tests', icon: 'star', href: '/tests' }
      ];
      ...
      navItems = [
        { id: 'profile', label: 'My Profile', icon: 'user', href: '/profile' },
        { id: 'notifications', label: 'Notifications', icon: 'bell', href: '/notifications' },
        { id: 'wallet', label: 'Wallet', icon: 'wallet', href: '/wallet', hidden: user.role !== 'student' },
        { id: 'opportunities', label: 'Opportunities', icon: 'star', href: '/opportunities', hidden: user.role !== 'student' },
        { id: 'universities', label: 'Universities', icon: 'building', href: '/universities' },
        { id: 'services', label: 'Services', icon: 'list', href: '/services' },
        { id: 'faq', label: 'FAQs', icon: 'document', href: '/faq' },
        { id: 'tests', label: 'System Tests', icon: 'star', href: '/tests' }
        ...
        <div class="sidebar-footer">
          ...
          <div class="user-profile-mini">
            ...
            <div class="mini-info">
              <h4>${user.fullName}</h4>
              <p>${user.isVerified
                ? '<span class="badge badge-green" style="padding:0px 4px;font-size:0.6rem;">Verified</span>'
                : (user.avatarStatus === 'pending'
                    ? '<span class="badge badge-gray" style="padding:0px 4px;font-size:0.6rem;">Pending Verification</span>'
